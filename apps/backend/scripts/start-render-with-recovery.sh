...
# Mark chat migration as applied since types/tables already exist
npx prisma migrate resolve --applied 20251122000000_add_chat_and_contacts_system 2>&1 | grep -v "No failed migration" || true
