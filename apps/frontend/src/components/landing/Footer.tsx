...
export function Footer() {
  ...
  return (
    <footer className="relative bg-surface-100 border-t border-white/5">
      <Container>
        {/* Main Footer Content */}
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-text-muted hover:text-white hover:border-white/20 transition-colors"
                  aria-label="Twitter"
                >
